...
public final class BodyDamage {
   ...
   public boolean AddRandomDamageFromZombie(IsoZombie var1, String var2) {
      ...
      if (GameServer.bServer) {
         ...
         if (this.ParentChar instanceof IsoPlayer && GameClient.bClient && ((IsoPlayer)this.ParentChar).isLocalPlayer()) {
            IsoPlayer var20 = (IsoPlayer)this.ParentChar;
            var20.updateMovementRates();
            GameClient.sendPlayerInjuries(var20);
            GameClient.sendPlayerDamage(var20);
         }
      ...
      if (!(this.getParentChar() instanceof IsoZombie)) {
         ...
         if (GameServer.bServer) {
            ...
            if (this.getOverallBodyHealth() != 0.0F) {
               ...
               IsoGameCharacter var16 = this.getParentChar();
               if (var15 > 0.0F) {
                  LuaEventManager.triggerEvent("OnPlayerGetDamage", var16, "POISON", var15);
               }

               if (var5 > 0.0F) {
                  LuaEventManager.triggerEvent("OnPlayerGetDamage", var16, "HUNGRY", var5);
               }

               if (var6 > 0.0F) {
                  LuaEventManager.triggerEvent("OnPlayerGetDamage", var16, "SICK", var6);
               }

               if (var7 > 0.0F) {
                  LuaEventManager.triggerEvent("OnPlayerGetDamage", var16, "BLEEDING", var7);
               }

               if (var8 > 0.0F) {
                  LuaEventManager.triggerEvent("OnPlayerGetDamage", var16, "THIRST", var8);
               }

               if (var9 > 0.0F) {
                  LuaEventManager.triggerEvent("OnPlayerGetDamage", var16, "HEAVYLOAD", var9);
               }
               ...
               if (var1 == this.ParentChar.getStats().Pain) {
                  var10000 = this.ParentChar.getStats();
                  var10000.Pain = (float)((double)var10000.Pain - 0.25 * (double)(GameTime.getInstance().getMultiplier() / 1.6F));
               }
