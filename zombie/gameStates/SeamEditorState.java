...
public final class SeamEditorState extends GameState {
   ...
   public void enter() {
      ...
      if (this.m_selfUI.size() == 0) {
         this.m_luaEnv.caller.pcall(this.m_luaEnv.thread, this.m_luaEnv.env.rawget("SeamEditorUI_InitUI"), new Object[0]);
   ...
   public GameStateMachine.StateAction update() {
      if (!this.bExit && !GameKeyboard.isKeyPressed(67) && !GameKeyboard.isKeyPressed(1)) {
         this.updateScene();
   ...
   public void save() {
      ...
      String var1 = var10000 + File.separator + "SeamEditorState-options.ini";
