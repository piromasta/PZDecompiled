...
public final class TileGeometryState extends GameState {
   ...
   private final BooleanDebugOption DrawPixelGrid = new BooleanDebugOption("DrawPixelGrid", true);
   private final BooleanDebugOption DrawSpriteGrid = new BooleanDebugOption("DrawSpriteGrid", false);
   private final BooleanDebugOption DrawSpriteGridTextureMask = new BooleanDebugOption("DrawSpriteGridTextureMask", false);
   private final BooleanDebugOption DrawSquareBox = new BooleanDebugOption("DrawSquareBox", false);
   private final BooleanDebugOption DrawSolidSquareBox = new BooleanDebugOption("DrawSolidSquareBox", false);
   ...
   private final BooleanDebugOption DrawTextureMask = new BooleanDebugOption("DrawTextureMask", false);
   private final BooleanDebugOption DrawTextureOutline = new BooleanDebugOption("DrawTextureOutline", false);
   private final BooleanDebugOption DrawUnderlyingSprite = new BooleanDebugOption("DrawUnderlyingSprite", false);
   ...
   public void enter() {
      ...
      if (this.m_selfUI.size() == 0) {
         this.m_luaEnv.caller.pcall(this.m_luaEnv.thread, this.m_luaEnv.env.rawget("TileGeometryEditor_InitUI"), new Object[0]);
   ...
   public Object fromLua1(String var1, Object var2) {
      switch (var1) {
         case "writeGeometryFile":
            ...
            TileGeometryManager.getInstance().write(var5);
            return null;
         default:
   ...
   public Object fromLua2(String var1, Object var2, Object var3) throws Exception {
      switch (var1) {
         case "reloadTilesetTexture":
            String var6 = (String)var2;
            String var7 = (String)var3;
            TileDepthTextureManager.getInstance().reloadTileset(var6, var7);
            return null;
         default:
   ...
   public void save() {
      ...
      String var1 = var10000 + File.separator + "TileGeometryState-options.ini";
