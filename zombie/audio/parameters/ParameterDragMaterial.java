...
public final class ParameterDragMaterial extends FMODLocalParameter {
   ...
   public ParameterDragMaterial(IsoGameCharacter var1) {
      super("DragMaterial");
      this.character = var1;
   }

   public float calculateCurrentValue() {
      return !this.character.isDraggingCorpse() ? (float)ParameterDragMaterial.DragMaterial.Concrete.label : (float)this.getMaterial().label;
   }
   ...
   private DragMaterial getMaterial() {
      ...
      if (var3 != null) {
         try {
            ...
            return ParameterDragMaterial.DragMaterial.valueOf(var12);
         } catch (IllegalArgumentException var9) {
            boolean var13 = true;
         }
      }

      return var11 != null ? ParameterDragMaterial.DragMaterial.Wood : ParameterDragMaterial.DragMaterial.Concrete;
   }
