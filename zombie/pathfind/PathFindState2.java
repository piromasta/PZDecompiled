...
public final class PathFindState2 extends State {
   ...
   public void execute(IsoGameCharacter var1) {
      ...
      if (var3 == PathFindBehavior2.BehaviorResult.Failed) {
         ...
         int var7 = PZMath.fastfloor(var1.getPathFindBehavior2().getTargetX());
         int var5 = PZMath.fastfloor(var1.getPathFindBehavior2().getTargetY());
         IsoChunk var6 = GameServer.bServer ? ServerMap.instance.getChunk(var7 / 8, var5 / 8) : IsoWorld.instance.CurrentCell.getChunkForGridSquare(var7, var5, 0);
         if (var6 == null) {
            var1.setVariable("bPathfind", false);
