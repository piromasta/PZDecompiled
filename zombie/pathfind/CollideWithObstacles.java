   ...
   void getObstaclesInRect(float var1, float var2, float var3, float var4, int var5, int var6, int var7) {
      ...
      for(var8 = 0; var8 < this.vehicles.size(); ++var8) {
         ...
         if (this.moveBounds.intersects(this.vehicleBounds)) {
            int var15 = PZMath.fastfloor(var10.z);
      ...
      if (!this.obstacles.isEmpty()) {
         ...
         for(var28 = var25; var28 < var27 - 1; ++var28) {
            for(var29 = var8; var29 < var26 - 1; ++var29) {
               ...
               if (var30 != null) {
                  if (var30.isSolid() || var30.isSolidTrans() && !var30.isAdjacentToWindow() && !var30.isAdjacentToHoppable() || var30.Has(IsoObjectType.stairsMN) || var30.Has(IsoObjectType.stairsTN) || var30.Has(IsoObjectType.stairsMW) || var30.Has(IsoObjectType.stairsTW)) {
   ...
   Vector2f resolveCollision(IsoGameCharacter var1, float var2, float var3, Vector2f var4) {
      ...
      if (var1.getCurrentSquare() != null && var1.getCurrentSquare().HasStairs()) {
         ...
         if (var6 == var2 && var7 == var3) {
            ...
            this.move.set(var2 - var1.getX(), var3 - var1.getY());
            this.move.normalize();
            ...
            this.getObstaclesInRect(Math.min(var6, var2), Math.min(var7, var3), Math.max(var6, var2), Math.max(var7, var3), PZMath.fastfloor(var1.getX()), PZMath.fastfloor(var1.getY()), PZMath.fastfloor(var1.getZ()));
            ...
            if (var5) {
               ...
               while(var38.hasNext()) {
                  ...
                  if (DebugOptions.instance.CollideWithObstacles.Render.Normals.getValue() && var37.getNormalAndEdgeVectors(this.nodeNormal, this.edgeVec)) {
            ...
            for(int var14 = 0; var14 < this.obstacles.size(); ++var14) {
               ...
               var16 = 0;
               if (var15.isPointInside(var1.getX(), var1.getY(), var16)) {
                  for(int var17 = 0; var17 < var15.edges.size(); ++var17) {
                     ...
                     if (var18.node1.visible.contains(var18.node2)) {
                        CCNode var19 = var18.closestPoint(var1.getX(), var1.getY(), this.closest);
                        double var20 = (double)((var1.getX() - this.closest.x) * (var1.getX() - this.closest.x) + (var1.getY() - this.closest.y) * (var1.getY() - this.closest.y));
                        if (var20 < var41) {
                           var41 = var20;
                           var39 = var18;
                           var37 = var19;
               ...
               for(var16 = 0; var16 < this.obstacles.size(); ++var16) {
                  ...
                  for(int var50 = 0; var50 < var47.edges.size(); ++var50) {
                     ...
                     if (var53.node1.visible.contains(var53.node2)) {
                        ...
                        if (var5 && DebugOptions.instance.CollideWithObstacles.Render.Normals.getValue()) {
