...
public class CollideWithObstaclesPoly {
   ...
   void getVehiclesInRect(float var1, float var2, float var3, float var4, int var5) {
      this.vehicles.clear();
      int var6 = (int)(var1 / 8.0F);
      int var7 = (int)(var2 / 8.0F);
      int var8 = (int)Math.ceil((double)(var3 / 8.0F));
      int var9 = (int)Math.ceil((double)(var4 / 8.0F));
         ...
         for(int var11 = var6; var11 < var8; ++var11) {
            ...
            if (var12 != null) {
               for(int var13 = 0; var13 < var12.vehicles.size(); ++var13) {
                  ...
                  if (var14.getScript() != null && (int)var14.getZ() == var5) {
   ...
   void getObstaclesInRect(float var1, float var2, float var3, float var4, int var5, int var6, int var7, boolean var8) {
      ...
      int var9 = (int)(this.moveBounds.x / 8.0F);
      int var10 = (int)(this.moveBounds.y / 8.0F);
      int var11 = (int)Math.ceil((double)(this.moveBounds.right() / 8.0F));
      int var12 = (int)Math.ceil((double)(this.moveBounds.bottom() / 8.0F));
   ...
   public Vector2f resolveCollision(IsoGameCharacter var1, float var2, float var3, Vector2f var4) {
      var4.set(var2, var3);
      boolean var5 = Core.bDebug && DebugOptions.instance.CollideWithObstacles.Render.Obstacles.getValue();
      float var6 = var1.getX();
      float var7 = var1.getY();
      float var8 = var2;
      float var9 = var3;
      if (var5) {
         LineDrawer.addLine(var6, var7, (float)PZMath.fastfloor(var1.getZ()), var2, var3, (float)PZMath.fastfloor(var1.getZ()), 1.0F, 1.0F, 1.0F, (String)null, true);
      }

      if (var6 == var2 && var7 == var3) {
         return var4;
      } else {
         move.set(var2 - var1.getX(), var3 - var1.getY());
         move.normalize();
         this.nodes.clear();
         this.obstacles.clear();
         this.getObstaclesInRect(Math.min(var6, var2), Math.min(var7, var3), Math.max(var6, var2), Math.max(var7, var3), PZMath.fastfloor(var1.getX()), PZMath.fastfloor(var1.getY()), PZMath.fastfloor(var1.getZ()), true);
         this.closestPointOnEdge.edge = null;
         this.closestPointOnEdge.node = null;
         this.closestPointOnEdge.distSq = 1.7976931348623157E308;

         int var12;
         for(int var10 = 0; var10 < this.obstacles.size(); ++var10) {
            CCObstacle var11 = (CCObstacle)this.obstacles.get(var10);
            var12 = 0;
            if (var11.isPointInside(var1.getX(), var1.getY(), var12)) {
               var11.getClosestPointOnEdge(var1.getX(), var1.getY(), this.closestPointOnEdge);
            }
         }
   ...
   boolean canStandAt(float var1, float var2, float var3, BaseVehicle var4, int var5) {
      ...
      this.nodes.clear();
      this.obstacles.clear();
      this.getObstaclesInRect(Math.min(var8, var10), Math.min(var9, var11), Math.max(var8, var10), Math.max(var9, var11), PZMath.fastfloor(var1), PZMath.fastfloor(var2), PZMath.fastfloor(var3), var4 == null);
   ...
   public boolean isNotClear(float var1, float var2, float var3, float var4, int var5, boolean var6, BaseVehicle var7, boolean var8, boolean var9) {
      ...
      int var18 = PZMath.fastfloor(var1);
      int var19 = PZMath.fastfloor(var2);
      int var20 = 1;
      byte var21;
      double var23;
      if (var14 == 0.0) {
         ...
         var21 = 1;
         var20 += PZMath.fastfloor(var3) - var18;
         var23 = (double)((float)(PZMath.fastfloor(var1) + 1) - var1) * var16;
      } else {
         var21 = -1;
         var20 += var18 - PZMath.fastfloor(var3);
         var23 = (double)(var1 - (float)PZMath.fastfloor(var1)) * var16;
      }
      ...
      if (var16 == 0.0) {
         ...
         var22 = 1;
         var20 += PZMath.fastfloor(var4) - var19;
         var23 -= (double)((float)(PZMath.fastfloor(var2) + 1) - var2) * var14;
      } else {
         var22 = -1;
         var20 += var19 - PZMath.fastfloor(var4);
         var23 -= (double)(var2 - (float)PZMath.fastfloor(var2)) * var14;
      }
      ...
      for(; var20 > 0; --var20) {
         ...
         if (var25 != null) {
            if (var6) {
               LineDrawer.addRect((float)(var18 * 8), (float)(var19 * 8), (float)var5, 8.0F, 8.0F, 1.0F, 1.0F, 1.0F);
            }
   ...
   private void vehicleMoved(VehiclePoly var1) {
      ...
      int var7 = PZMath.fastfloor(var1.z);
      int var8 = (var3 - var2) / 8;
      int var9 = (var4 - var2) / 8;
      int var10 = (int)Math.ceil((double)(((float)(var5 + var2) - 1.0F) / 8.0F));
      int var11 = (int)Math.ceil((double)(((float)(var6 + var2) - 1.0F) / 8.0F));
   ...
   public void render() {
      boolean var1 = Core.bDebug && DebugOptions.instance.CollideWithObstacles.Render.Obstacles.getValue();
      if (var1) {
         ...
         this.nodes.clear();
         this.obstacles.clear();
         this.getObstaclesInRect(var2.getX(), var2.getY(), var2.getX(), var2.getY(), PZMath.fastfloor(var2.getX()), PZMath.fastfloor(var2.getY()), PZMath.fastfloor(var2.getZ()), true);
         Iterator var3;
   ...
   public static final class ChunkDataZ {
      ...
      public void init(IsoChunk var1, int var2, CollideWithObstaclesPoly var3) {
         ...
         int var9;
         for(int var8 = var7 - 2; var8 < var7 + 8 + 2; ++var8) {
            for(var9 = var6 - 2; var9 < var6 + 8 + 2; ++var9) {
               IsoGridSquare var10 = IsoWorld.instance.CurrentCell.getGridSquare(var9, var8, var2);
               if (var10 != null && !var10.getObjects().isEmpty()) {
                  if (var10.isSolid() || var10.isSolidTrans() && !var10.isAdjacentToWindow() && !var10.isAdjacentToHoppable()) {
         ...
         for(int var37 = 0; var37 < var3.vehicles.size(); ++var37) {
            ...
            VehiclePoly var16 = var38.getPolyPlusRadius();
   ...
   private static final class CCObstacle {
      ...
      static void releaseAll(ArrayList<CCObstacle> var0) {
   ...
   private static final class CCEdge {
      ...
      static void releaseAll(ArrayList<CCEdge> var0) {
         pool.releaseAll(var0);
      }
   }
   ...
   private static final class CCNode {
      ...
      static void releaseAll(ArrayList<CCNode> var0) {
         pool.releaseAll(var0);
      }
   }
   ...
   private static final class CCEdgeRing extends ArrayList<CCEdge> {
      ...
      void lineSegmentIntersect(float var1, float var2, float var3, float var4, ClosestPointOnEdge var5, boolean var6) {
         ...
         for(int var7 = 0; var7 < this.size(); ++var7) {
            ...
            if (!(var9 >= 0.0F)) {
               ...
               if (var6 && DebugOptions.instance.CollideWithObstacles.Render.Normals.getValue()) {
      ...
      static void releaseAll(ArrayList<CCEdgeRing> var0) {
         pool.releaseAll(var0);
      }
   }
