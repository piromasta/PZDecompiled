...
public final class CGlobalObjectSystem extends GlobalObjectSystem {
   ...
   public void receiveNewLuaObjectAt(int var1, int var2, int var3, KahluaTable var4) {
      ...
      if (var5 == null) {
         ...
         LuaManager.caller.pcall(LuaManager.thread, var5, new Object[]{this.modData, BoxedStaticValues.toDouble((double)var1), BoxedStaticValues.toDouble((double)var2), BoxedStaticValues.toDouble((double)var3)});
   ...
   public void receiveRemoveLuaObjectAt(int var1, int var2, int var3) {
      ...
      if (var4 == null) {
         ...
         LuaManager.caller.pcall(LuaManager.thread, var4, new Object[]{this.modData, BoxedStaticValues.toDouble((double)var1), BoxedStaticValues.toDouble((double)var2), BoxedStaticValues.toDouble((double)var3)});
      }
   }
