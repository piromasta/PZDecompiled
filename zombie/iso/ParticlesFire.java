...
public final class ParticlesFire extends Particles {
   ...
   public ParticlesFire() {
      ...
      this.zones.clear();
      float var1 = (float)PZMath.fastfloor(IsoCamera.frameState.OffX + (float)(IsoCamera.frameState.OffscreenWidth / 2));
      float var2 = (float)PZMath.fastfloor(IsoCamera.frameState.OffY + (float)(IsoCamera.frameState.OffscreenHeight / 2));
   ...
   public class Zone {
      ...
      Zone(int var2, float var3, float var4, float var5) {
         ...
         this.y0 = var4;
         this.r = var5;
         this.area = (float)(3.141592653589793 * (double)var5 * (double)var5);
