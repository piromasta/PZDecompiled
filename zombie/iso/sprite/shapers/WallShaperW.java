...
public class WallShaperW extends WallShaper {
   ...
   public void accept(TextureDraw var1) {
      ...
      if (var1.tex1 != null) {
         var1.tex1_u1 = var1.tex1_u0 * 0.5F + var1.tex1_u1 * 0.5F;
         var1.tex1_u2 = var1.tex1_u2 * 0.5F + var1.tex1_u3 * 0.5F;
      }

      if (var1.tex2 != null) {
         var1.tex2_u1 = var1.tex2_u0 * 0.5F + var1.tex2_u1 * 0.5F;
         var1.tex2_u2 = var1.tex2_u2 * 0.5F + var1.tex2_u3 * 0.5F;
      }
