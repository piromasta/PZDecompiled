...
public final class ImportedStaticMesh {
   ...
   private void processAiScene(AiMesh var1) {
      ...
      VertexBufferObject.VertexFormat var12 = new VertexBufferObject.VertexFormat(2 + var3);
      ...
      for(int var5 = 0; var5 < var3; ++var5) {
         var12.setElement(2 + var5, VertexBufferObject.VertexType.TextureCoordArray, 8);
      }
         ...
         if (var3 > 0) {
            ...
            for(int var11 = 0; var11 < 8; ++var11) {
               if (var1.hasTexCoords(var11)) {
                  this.verticesUnskinned.setElement(var6, 2 + var10, var1.getTexCoordU(var6, var11), 1.0F - var1.getTexCoordV(var6, var11));
                  ++var10;
               }
            }
         }
