...
public final class HeightTerrain {
   ...
   double calcTerrain(float var1, float var2) {
      var1 *= 10.0F;
      var2 *= 10.0F;
      double var3 = this.noise.eval((double)(var1 / 900.0F), (double)(var2 / 600.0F), 0.0);
      var3 += this.noise.eval((double)(var1 / 600.0F), (double)(var2 / 600.0F), 0.0) / 4.0;
      var3 += (this.noise.eval((double)(var1 / 300.0F), (double)(var2 / 300.0F), 0.0) + 1.0) / 8.0;
      var3 += (this.noise.eval((double)(var1 / 150.0F), (double)(var2 / 150.0F), 0.0) + 1.0) / 16.0;
      var3 += (this.noise.eval((double)(var1 / 75.0F), (double)(var2 / 75.0F), 0.0) + 1.0) / 32.0;
      double var5 = (this.noise.eval((double)var1, (double)var2, 0.0) + 1.0) / 2.0;
      double var10000 = var5 * ((this.noise.eval((double)var1, (double)var2, 0.0) + 1.0) / 2.0);
      return var3;
   }
