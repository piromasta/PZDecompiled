...
public final class IndieGL {
   ...
   public static <T1> void bindShader(Shader var0, T1 var1, Invokers.Params1.ICallback<T1> var2) {
      Lambda.capture(var0, var1, var2, (var0x, var1x, var2x, var3) -> {
         bindShader(var1x, var0x.invoker(var2x, var3));
      });
   }

   public static <T1, T2> void bindShader(Shader var0, T1 var1, T2 var2, Invokers.Params2.ICallback<T1, T2> var3) {
      Lambda.capture(var0, var1, var2, var3, (var0x, var1x, var2x, var3x, var4) -> {
         bindShader(var1x, var0x.invoker(var2x, var3x, var4));
      });
   }

   public static <T1, T2, T3> void bindShader(Shader var0, T1 var1, T2 var2, T3 var3, Invokers.Params3.ICallback<T1, T2, T3> var4) {
   ...
   public static <T1, T2, T3, T4> void bindShader(Shader var0, T1 var1, T2 var2, T3 var3, T4 var4, Invokers.Params4.ICallback<T1, T2, T3, T4> var5) {
