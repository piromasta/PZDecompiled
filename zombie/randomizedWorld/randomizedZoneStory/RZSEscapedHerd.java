...
public class RZSEscapedHerd extends RandomizedZoneStoryBase {
   ...
   public void randomizeZoneStory(Zone var1) {
      ...
      int var9 = Rand.Next(1, 6);

      for(int var10 = 0; var10 < var9; ++var10) {
         var7 = getRandomExtraFreeUnoccupiedSquare(this, var1);
         var8 = new IsoAnimal(IsoWorld.instance.getCell(), var7.getX(), var7.getY(), var7.getZ(), var6, var5);
         var8.addToWorld();
         var8.randomizeAge();
         if (Rand.NextBool(2)) {
