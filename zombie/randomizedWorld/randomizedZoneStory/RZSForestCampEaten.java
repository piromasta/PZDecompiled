...
public class RZSForestCampEaten extends RandomizedZoneStoryBase {
   ...
   public void randomizeZoneStory(IsoMetaGrid.Zone var1) {
      ...
      ArrayList var16 = this.addZombiesOnSquare(1, "Camper", (Integer)null, this.getRandomFreeSquare(this, var1));
      IsoZombie var12 = var16.isEmpty() ? null : (IsoZombie)var16.get(0);
