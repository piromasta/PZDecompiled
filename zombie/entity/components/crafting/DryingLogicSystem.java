...
public class DryingLogicSystem extends EngineSystem {
   ...
   public DryingLogicSystem(int var1) {
   ...
   public void addedToEngine(Engine var1) {
      this.dryingLogicEntities = var1.getBucket(Family.all(ComponentType.DryingLogic, ComponentType.Resources).get());
   }
   ...
   public void updateSimulation() {
      if (!GameClient.bClient) {
         ImmutableArray var1 = this.dryingLogicEntities.getEntities();
         if (var1.size() != 0) {
            for(int var9 = 0; var9 < var1.size(); ++var9) {
               GameEntity var2 = (GameEntity)var1.get(var9);
               if (this.isValidEntity(var2)) {
                  DryingLogic var3 = (DryingLogic)var2.getComponent(ComponentType.DryingLogic);
                  ...
                  if (var3.isValid() && var4.isValid()) {
                     ...
                     ResourceGroup var7 = var4.getResourceGroup(var3.getDryingInputsGroupName());
                     ResourceGroup var8 = var4.getResourceGroup(var3.getDryingOutputsGroupName());
                     if (this.verifyDryingLogicSlots(var3, var7, var8) && var3.getSlotSize() != 0) {
                        this.updateDryingLogic(var3, var5, var6);
                     }
                  }
               }
            }
   ...
   private boolean verifyDryingLogicSlots(DryingLogic var1, ResourceGroup var2, ResourceGroup var3) {
      if (var2 != null && !var2.getResources().isEmpty() && var3 != null && !var3.getResources().isEmpty()) {
         if (var2.getResources().size() != var3.getResources().size()) {
            ...
            for(int var6 = 0; var6 < var2.getResources().size(); ++var6) {
               ...
               DryingLogic.DryingSlot var7 = var1.getSlot(var6);
               if (var7 == null) {
   ...
   private void updateDryingLogic(DryingLogic var1, ResourceGroup var2, ResourceGroup var3) {
      if (!var1.isRunning() && var1.isUsesFuel()) {
         if (var1.isUsesFuel()) {
            if (var1.isStartRequested()) {
         ...
         if (var1.isUsesFuel() && var3 != null && var3.isDirty() && !var1.getCraftData().canCreateOutputs(var3.getResources())) {
            this.cancel(var1, var3);
            return;
         }

         if (var1.isUsesFuel() && var1.isFinished()) {
            this.finish(var1, var3);
            return;
         }

         this.updateDryingSlots(var1, false);
         if (var1.isUsesFuel()) {
   ...
   private void updateDryingSlots(DryingLogic var1, boolean var2) {
      int var3 = var1.getSlotSize();

      for(int var4 = 0; var4 < var3; ++var4) {
         DryingLogic.DryingSlot var5 = var1.getSlot(var4);
         if (var5 != null) {
            ResourceItem var6;
            ResourceItem var7;
            if (var2) {
   ...
   private void getSlotRecipe(DryingLogic var1, DryingLogic.DryingSlot var2, int var3) {
      ...
      CraftRecipe var6 = CraftUtil.getPossibleRecipe(this.slotCraftTestData, var1.getDryingRecipes(), this.tempSlotInputResources, this.tempSlotOutputResources);
      if (var6 != null) {
         var2.setRecipe(var6);
      } else {
         var2.clearRecipe();
   ...
   private void craftSlotRecipe(DryingLogic var1, DryingLogic.DryingSlot var2, Resource var3, Resource var4) {
   ...
   private float getDryingFactor(DryingLogic var1) {
      GameEntity var2 = var1.getGameEntity();
      float var3 = CraftUtil.getEntityTemperature(var2);
      var3 = PZMath.clamp(var3, 0.0F, 40.0F);
      var3 /= 20.0F;
      if (var3 < 1.0F) {
         var3 *= var3;
      }
   ...
   private void start(DryingLogic var1, StartMode var2, IsoPlayer var3, ResourceGroup var4) {
      if (!GameClient.bClient) {
         if (var1.isUsesFuel() && var1.canStart(var2, var3)) {
   ...
   private void cancel(DryingLogic var1, ResourceGroup var2) {
      this.stop(var1, true, var2);
   }

   private void finish(DryingLogic var1, ResourceGroup var2) {
      this.stop(var1, false, var2);
   }

   private void stop(DryingLogic var1, boolean var2, ResourceGroup var3) {
      if (!GameClient.bClient) {
         if (var1.isValid()) {
            if (var1.isRunning()) {
               if (var1.isUsesFuel()) {
                  ...
                  this.updateDryingSlots(var1, true);
