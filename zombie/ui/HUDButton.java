...
public class HUDButton extends UIElement {
   ...
   public void render() {
      ...
      if (!this.mouseOver && !this.name.equals(this.display.getClickedValue())) {
         this.DrawTextureScaled(this.texture, 0.0, (double)var1, this.getWidth(), this.getHeight(), (double)this.notclickedAlpha);
      } else {
         this.DrawTextureScaled(this.highlight, 0.0, (double)var1, this.getWidth(), this.getHeight(), (double)this.clickedalpha);
      }

      if (this.overicon != null) {
         this.DrawTextureScaled(this.overicon, 0.0, (double)var1, (double)this.overicon.getWidth(), (double)this.overicon.getHeight(), 1.0);
      }
