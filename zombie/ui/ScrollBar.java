...
public final class ScrollBar extends UIElement {
   ...
   public void render() {
      if (this.IsVerticle) {
         ...
         this.DrawTextureScaledCol(this.ButtonTopVertical, 1.0, (double)((int)this.ButtonOffset + 1), (double)this.ButtonThickness, (double)this.ButtonEndLength, var1);
         this.DrawTextureScaledCol(this.ButtonBackVertical, 1.0, (double)((int)this.ButtonOffset + 1 + this.ButtonEndLength), (double)this.ButtonThickness, (double)this.ButtonInsideLength, var1);
         this.DrawTextureScaledCol(this.ButtonBottomVertical, 1.0, (double)((float)((int)this.ButtonOffset + 1 + this.ButtonEndLength) + this.ButtonInsideLength), (double)this.ButtonThickness, (double)this.ButtonEndLength, var1);
      }
