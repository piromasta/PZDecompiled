...
public final class UI_BodyPart extends UIElement {
   ...
   public void render() {
      ...
      if (this.infectionTex != null && !var1.IsBandaged(this.BodyPartType) && var1.getBodyPart(this.BodyPartType).getWoundInfectionLevel() > 0.0F) {
         this.DrawTexture(this.infectionTex, 0.0, 0.0, (double)(var1.getBodyPart(this.BodyPartType).getWoundInfectionLevel() / 10.0F));
      }
      ...
      if (this.bandageTex != null && var1.IsBandaged(this.BodyPartType) && var1.getBodyPart(this.BodyPartType).getBandageLife() > 0.0F) {
         ...
         this.DrawTexture(this.scratchTex, 0.0, 0.0, (double)(var1.getBodyPart(this.BodyPartType).getScratchTime() / 20.0F));
      } else if (this.scratchTex != null && var1.IsCut(this.BodyPartType)) {
         this.DrawTexture(this.scratchTex, 0.0, 0.0, (double)(var1.getBodyPart(this.BodyPartType).getCutTime() / 20.0F));
         ...
         this.DrawTexture(this.deepWoundTex, 0.0, 0.0, (double)(var1.getBodyPart(this.BodyPartType).getDeepWoundTime() / 15.0F));
      ...
      if (this.burnTex != null && var1.getBodyPart(this.BodyPartType).getBurnTime() > 0.0F && !var1.getBodyPart(this.BodyPartType).bandaged()) {
         this.DrawTexture(this.burnTex, 0.0, 0.0, (double)(var1.getBodyPart(this.BodyPartType).getBurnTime() / 100.0F));
      }
